...
You can find some HTML mockups for the main page, the listing page, and the new issue page [at the end of the 2nd practice](#!/subjects/webeng/practices/02#solutions), and put them into `app.component.html` under each other. Now you have three functionalities in one page.
